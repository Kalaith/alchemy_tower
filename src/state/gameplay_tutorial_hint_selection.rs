...
impl GameplayState {
    pub(super) fn take_next_tutorial_hint(
        ...
        if !self.runtime.tutorial.crow_intro_hint_shown {
        ...
        if !self.runtime.tutorial.save_hint_shown {
        ...
        if !self.runtime.tutorial.journal_hint_shown {
        ...
        if !self.runtime.tutorial.alchemy_hint_shown && near_alchemy {
        ...
        if !self.runtime.tutorial.brew_goal_hint_shown
        ...
        if !self.runtime.tutorial.potion_hint_shown && has_quick_potions {
            ...
            return Some((
                ...
                TutorialHintTone::Item,
            ));
        }
        if !self.runtime.tutorial.gather_hint_shown
        ...
        if !self.runtime.tutorial.mira_hint_shown
            && self.progression.total_brews > 0
            && !self
                .progression
                .completed_quests
        ...
        if !self.runtime.tutorial.rowan_hint_shown
            && self
                .progression
                .completed_quests
                .contains("healing_for_mira")
        ...
        if !self.runtime.tutorial.quest_hint_shown
        ...
        if !self.runtime.tutorial.route_hint_shown && unlockable_warp_here {
